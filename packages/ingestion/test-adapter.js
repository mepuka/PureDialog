...
import { toDomainVideo, apiVideoToMediaResource } from "./src/adapters/youtube.js";
...
// Run the test
Effect.runPromise(testAdapter).then((result) => console.log("🎉", result), (error) => console.error("❌ Test failed:", error));
