...
import { isValidChannelId, isValidVideoId, YouTubeChannelId, YouTubeVideoId } from "./types.js"
 ...
 */
export const isValidYoutubeChannelUrl = (url: string): url is string => Option.isSome(extractChannelId(url))
