...
const program = Effect.gen(function* () {
    ...
    const video = yield* youtubeService.getVideo(videoId).pipe(Effect.catchAll((error) => Effect.gen(function* () {
    ...
    const searchResults = yield* youtubeService.searchVideos("Effect TypeScript", 3).pipe(Effect.catchAll((error) => Effect.gen(function* () {
